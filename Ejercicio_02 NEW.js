...
//Se crea una cámara, que define dónde estamos mirando.
 {
    ...
    Dim = prompt("Digite el tamaño del que cubo que desee", " ejemplo. 25");//Se crea esta variable como cuadro de texto, donde al usuario le aparece un mensaje y a su vez la opcion de digitalizar un dato
    ...
    var Angulo = prompt("Digite el ángulo que desea en grados", " ejemplo. 25");//Se crea esta variable como cuadro de texto, donde al usuario le aparece un mensaje y a su vez la opcion de digitalizar un dato
    ...
    {
        Tamano=1/(2*i);//Varible para escalar el tamaño respeto al cubo indicado, es decir el valor de la mitad del cubo anterior.
